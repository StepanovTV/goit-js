...
// Если логин валиден,
// функция addLogin проверяеть уникальность логина с помощью функции isLoginUnique
...
const isLoginValid = function isLoginValid(login, loginCharMin = 4, loginCharMax = 16) {
  const result = login.length >= loginCharMin && login.length <= loginCharMax;
  return result;
};
...
// Вызовы функции для'robotGoogles') проверки
